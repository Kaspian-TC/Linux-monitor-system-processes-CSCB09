(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[43],{"0FJJ":function(t,e,i){"use strict"
...
var m=i("FdVj")
var y=i("cRz0")
function T(t,e){if(!(t&&e))return false
const i=new URL(t)
const s=new URL(e)
return i.origin===s.origin}var b,D,v,S,x=function(t,e){return function(){return t.apply(e,arguments)}},w=function(t,e){for(var i in e)A.call(e,i)&&(t[i]=e[i])
function s(){this.constructor=t}s.prototype=e.prototype
t.prototype=new s
t.__super__=e.prototype
return t},A={}.hasOwnProperty
b=Object(g["useScope"])("models_Assignment")
D=function(){var t
...
w(i,t)
function i(){this.quizzesRespondusEnabled=x(this.quizzesRespondusEnabled,this)
this.showGradersAnonymousToGradersCheckbox=x(this.showGradersAnonymousToGradersCheckbox,this)
this.pollUntilFinished=x(this.pollUntilFinished,this)
this.pollUntilFinishedLoading=x(this.pollUntilFinishedLoading,this)
this.pollUntilFinishedMigrating=x(this.pollUntilFinishedMigrating,this)
this.pollUntilFinishedImporting=x(this.pollUntilFinishedImporting,this)
this.pollUntilFinishedDuplicating=x(this.pollUntilFinishedDuplicating,this)
this.retry_migration=x(this.retry_migration,this)
this.duplicate_failed=x(this.duplicate_failed,this)
this.duplicate=x(this.duplicate,this)
this.setNullDates=x(this.setNullDates,this)
this._filterFrozenAttributes=x(this._filterFrozenAttributes,this)
this._getAssignmentType=x(this._getAssignmentType,this)
this._hasOnlyType=x(this._hasOnlyType,this)
this._submissionTypes=x(this._submissionTypes,this)
this.toView=x(this.toView,this)
this.submissionTypesFrozen=x(this.submissionTypesFrozen,this)
this.failedToImport=x(this.failedToImport,this)
this.isImporting=x(this.isImporting,this)
this.isQuizLTIAssignment=x(this.isQuizLTIAssignment,this)
this.is_quiz_assignment=x(this.is_quiz_assignment,this)
this.originalAssignmentName=x(this.originalAssignmentName,this)
this.originalAssignmentID=x(this.originalAssignmentID,this)
this.originalQuizID=x(this.originalQuizID,this)
this.originalCourseID=x(this.originalCourseID,this)
this.failedToMigrate=x(this.failedToMigrate,this)
this.failedToDuplicate=x(this.failedToDuplicate,this)
this.isMigrating=x(this.isMigrating,this)
this.isDuplicating=x(this.isDuplicating,this)
this.canDuplicate=x(this.canDuplicate,this)
this.singleSectionDueDate=x(this.singleSectionDueDate,this)
this.singleSection=x(this.singleSection,this)
this.allDates=x(this.allDates,this)
this.nonBaseDates=x(this.nonBaseDates,this)
this.hasPointsPossible=x(this.hasPointsPossible,this)
this.hasDueDate=x(this.hasDueDate,this)
this.multipleDueDates=x(this.multipleDueDates,this)
this.defaultDates=x(this.defaultDates,this)
this.showBuildButton=x(this.showBuildButton,this)
this.newQuizzesAssignmentBuildButtonEnabled=x(this.newQuizzesAssignmentBuildButtonEnabled,this)
this.submissionTypeSelectionTools=x(this.submissionTypeSelectionTools,this)
this.dueDateRequiredForAccount=x(this.dueDateRequiredForAccount,this)
this.maxNameLengthRequiredForAccount=x(this.maxNameLengthRequiredForAccount,this)
this.maxNameLength=x(this.maxNameLength,this)
this.sisIntegrationSettingsEnabled=x(this.sisIntegrationSettingsEnabled,this)
this.postToSISName=x(this.postToSISName,this)
this.postToSISEnabled=x(this.postToSISEnabled,this)
this.labelId=x(this.labelId,this)
this.htmlBuildUrl=x(this.htmlBuildUrl,this)
this.htmlEditUrl=x(this.htmlEditUrl,this)
this.htmlUrl=x(this.htmlUrl,this)
this.objectType=x(this.objectType,this)
this.iconType=x(this.iconType,this)
this.useNewQuizIcon=x(this.useNewQuizIcon,this)
this.published=x(this.published,this)
this.isGpaScaled=x(this.isGpaScaled,this)
this.isLetterGraded=x(this.isLetterGraded,this)
this.isSimple=x(this.isSimple,this)
this.externalToolNewTab=x(this.externalToolNewTab,this)
this.externalToolDataStudentLabelText=x(this.externalToolDataStudentLabelText,this)
this.isMasteryConnectTool=x(this.isMasteryConnectTool,this)
this.externalToolCustomParamsStringified=x(this.externalToolCustomParamsStringified,this)
this.externalToolCustomParams=x(this.externalToolCustomParams,this)
this.externalToolDataStringified=x(this.externalToolDataStringified,this)
this.externalToolData=x(this.externalToolData,this)
this.externalToolIframeHeight=x(this.externalToolIframeHeight,this)
this.externalToolIframeWidth=x(this.externalToolIframeWidth,this)
this.externalToolUrl=x(this.externalToolUrl,this)
this.gradingStandardId=x(this.gradingStandardId,this)
this.groupCategoryId=x(this.groupCategoryId,this)
this.vericiteEnabled=x(this.vericiteEnabled,this)
this.turnitinEnabled=x(this.turnitinEnabled,this)
this.gradeGroupStudentsIndividually=x(this.gradeGroupStudentsIndividually,this)
this.vericiteAvailable=x(this.vericiteAvailable,this)
this.turnitinAvailable=x(this.turnitinAvailable,this)
this.allowedExtensions=x(this.allowedExtensions,this)
this.restrictFileExtensions=x(this.restrictFileExtensions,this)
this.notifyOfUpdate=x(this.notifyOfUpdate,this)
this.peerReviewsAssignAt=x(this.peerReviewsAssignAt,this)
this.peerReviewCount=x(this.peerReviewCount,this)
this.automaticPeerReviews=x(this.automaticPeerReviews,this)
this.anonymousPeerReviews=x(this.anonymousPeerReviews,this)
this.peerReviews=x(this.peerReviews,this)
this.graderCommentsVisibleToGraders=x(this.graderCommentsVisibleToGraders,this)
this.gradersAnonymousToGraders=x(this.gradersAnonymousToGraders,this)
this.anonymousGrading=x(this.anonymousGrading,this)
this.anonymousInstructorAnnotations=x(this.anonymousInstructorAnnotations,this)
this.moderatedGrading=x(this.moderatedGrading,this)
this.postToSIS=x(this.postToSIS,this)
this.isOnlineSubmission=x(this.isOnlineSubmission,this)
this.acceptsOnlineTextEntries=x(this.acceptsOnlineTextEntries,this)
this.acceptsMediaRecording=x(this.acceptsMediaRecording,this)
this.acceptsOnlineURL=x(this.acceptsOnlineURL,this)
this.acceptsAnnotatedDocument=x(this.acceptsAnnotatedDocument,this)
this.acceptsOnlineUpload=x(this.acceptsOnlineUpload,this)
this.withoutGradedSubmission=x(this.withoutGradedSubmission,this)
this.hasSubmittedSubmissions=x(this.hasSubmittedSubmissions,this)
this.allowedToSubmit=x(this.allowedToSubmit,this)
this.expectsSubmission=x(this.expectsSubmission,this)
this.submissionType=x(this.submissionType,this)
this.selectedSubmissionTypeToolId=x(this.selectedSubmissionTypeToolId,this)
this.isNonPlacementExternalTool=x(this.isNonPlacementExternalTool,this)
this.isGenericExternalTool=x(this.isGenericExternalTool,this)
this.defaultToolSelected=x(this.defaultToolSelected,this)
this.isQuickCreateDefaultTool=x(this.isQuickCreateDefaultTool,this)
this.defaultToOnPaper=x(this.defaultToOnPaper,this)
this.defaultToOnline=x(this.defaultToOnline,this)
this.defaultToNone=x(this.defaultToNone,this)
this.isDefaultTool=x(this.isDefaultTool,this)
this.shouldShowDefaultTool=x(this.shouldShowDefaultTool,this)
this.isNewAssignment=x(this.isNewAssignment,this)
this.submissionTypes=x(this.submissionTypes,this)
this.inPacedCourse=x(this.inPacedCourse,this)
this.courseID=x(this.courseID,this)
this.omitFromFinalGrade=x(this.omitFromFinalGrade,this)
this.gradingType=x(this.gradingType,this)
this.inClosedGradingPeriod=x(this.inClosedGradingPeriod,this)
this.frozenAttributes=x(this.frozenAttributes,this)
this.frozen=x(this.frozen,this)
this.freezeOnCopy=x(this.freezeOnCopy,this)
this.canMove=x(this.canMove,this)
this.canDelete=x(this.canDelete,this)
this.canFreeze=x(this.canFreeze,this)
this.assignmentGroupId=x(this.assignmentGroupId,this)
this.secureParams=x(this.secureParams,this)
this.pointsPossible=x(this.pointsPossible,this)
this.name=x(this.name,this)
this.description=x(this.description,this)
this.importantDates=x(this.importantDates,this)
this.dueDateRequired=x(this.dueDateRequired,this)
this.lockAt=x(this.lockAt,this)
this.unlockAt=x(this.unlockAt,this)
this.dueAt=x(this.dueAt,this)
this.assignmentType=x(this.assignmentType,this)
this.isAssignment=x(this.isAssignment,this)
this.isNotGraded=x(this.isNotGraded,this)
this.defaultToolUrl=x(this.defaultToolUrl,this)
this.defaultToolName=x(this.defaultToolName,this)
this.isNonPlacementExternalTool=x(this.isNonPlacementExternalTool,this)
this.isExternalTool=x(this.isExternalTool,this)
this.isPage=x(this.isPage,this)
this.isDiscussionTopic=x(this.isDiscussionTopic,this)
this.isQuiz=x(this.isQuiz,this)
...
i.prototype.inPacedCourse=function(){return this.get("in_paced_course")}
...
i.prototype.isPlagiarismPlatformLocked=function(){return this.get("has_submitted_submissions")||r.a.includes(this.frozenAttributes(),"submission_types")}
...
i.prototype.externalToolIframeWidth=function(t){var e,i
i=this.get("external_tool_tag_attributes")||{}
if(!(arguments.length>0))return null!=i&&null!=(e=i.iframe)?e.width:void 0
i.iframe.width=t
return this.set("external_tool_tag_attributes",i)}
i.prototype.externalToolIframeHeight=function(t){var e,i
i=this.get("external_tool_tag_attributes")||{}
if(!(arguments.length>0))return null!=i&&null!=(e=i.iframe)?e.height:void 0
i.iframe.height=t
return this.set("external_tool_tag_attributes",i)}
...
t=this.externalToolData()
if(!t)return""
if(1===t.studentCount)return b.t("Student")
return b.t("Students")}
...
return"Assignment"}
i.prototype.objectTypeDisplayName=function(){if(this.isQuiz()||this.isQuizLTIAssignment()&&S())return b.t("Quiz")
if(this.isQuizLTIAssignment())return b.t("New Quiz")
if(this.isDiscussionTopic())return b.t("Discussion Topic")
if(this.isPage())return b.t("Page")
return b.t("Assignment")}
i.prototype.htmlUrl=function(){return this.isQuizLTIAssignment()&&D()&&ENV.FLAGS&&ENV.FLAGS.new_quizzes_modules_support?this.htmlEditUrl()+"?quiz_lti":this.get("html_url")}
...
i.prototype.disabledMessage=function(){return b.t("Can't unpublish %{name} if there are student submissions",{name:this.get("name")})}
...
//# sourceMappingURL=43-c-64a44bbc95.js.map