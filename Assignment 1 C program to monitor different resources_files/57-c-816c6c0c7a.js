...
function m(t,e,n){if("string"!==typeof e){if(b){var i=p(e)
i&&i!==b&&m(t,i,n)}var r=h(e)
d&&(r=r.concat(d(e)))
var o=u(t)
var a=u(e)
for(var l=0;l<r.length;++l){var g=r[l]
if(!s[g]&&!(n&&n[g])&&!(a&&a[g])&&!(o&&o[g])){var y=f(e,g)
...
let i=n.offset(),s=n.outerWidth(),o=n.outerHeight(),a=i.top,l=a+o,u=i.left,c=u+s,h="html,body"==this.selector?r.a.windowScrollTop():this.scrollTop(),d=this.scrollLeft(),f=this.outerHeight(),p=this.outerWidth()
...
l-=t.top
u-=t.left
c-=t.left}if("HTML"==this[0].tagName||"BODY"==this[0].tagName){f=r()(window).height()
r()("#wizard_box:visible").length>0&&(f-=r()("#wizard_box:visible").height())
p=r()(window).width()
a-=h
u-=d
l-=h
c-=d}a<0||f<o&&l>f?e.scrollTop=a+h:l>f&&(e.scrollTop=l+h-f+20)
u<0?e.scrollLeft=u+d:c>p&&(e.scrollLeft=c+d-p+20)
...
function n(t){return[t[0].replace(/\[\d+\]$/,"[]").replace(/{/g,"[").replace(/}/g,"]"),t[1]]}function i(t,n,r){if(n instanceof Function)e.push([t+r,n()])
else if(n instanceof Array)for(const e in n)i(t,n[e],`${r}[${e}]`)
else if(n instanceof Object)for(const e in n)i(t,n[e],`${r}{${e}}`)
else"boolean"===typeof n||"number"===typeof n?e.push([t+r,n.toString()]):"undefined"===typeof n?e.push([t+r,"undefined"]):null===n?e.push([t+r,"null"]):"string"===typeof n&&e.push([t+r,n])}for(const e in t)i(e,t[e],"")
return new URLSearchParams(e.map(n)).toString()}function l({path:t,params:e}){const n=a(e)
if(0===n.length)return t
return t+"?"+n}async function u({path:t,method:e="GET",headers:n={},params:r={},body:a,fetchOpts:u={}}){const c={...o["e"]}
c.headers["X-CSRF-Token"]=Object(i["a"])("_csrf_token")
if(a&&"string"!==typeof a){a=JSON.stringify(a)
c.headers["Content-Type"]="application/json"}Object.assign(c.headers,n)
Object.assign(c,u)
const h=l({path:t,params:r})
const d=await fetch(h,{body:a,method:e,...c})
if(!d.ok){const t=new Error(`doFetchApi received a bad response: ${d.status} ${d.statusText}`)
Object.assign(t,{response:d})
throw t}const f=d.headers.get("Link")
const p=f&&s()(f)||void 0
const b=await d.text()
const m=b.length>0?JSON.parse(b):void 0
return{json:m,response:d,link:p}}},Nuch:function(t,e,n){"use strict"
...
const u=Object(s["lazy"])(()=>Promise.all([n.e(10),n.e(13),n.e(15),n.e(114),n.e(4194)]).then(n.bind(null,"dpkT")))
...
var d=n("uloQ")
var f=n("Ipg6")
const p=Object(r["useScope"])("direct_share_user_modal")
const b=Object(s["lazy"])(()=>Promise.all([n.e(10),n.e(13),n.e(15),n.e(4154)]).then(n.bind(null,"pdP4")))
...
function _(){m([])
y(null)}function w(t){r.find(e=>e.id===t.id)||m(r.concat([t]))}function x(t){m(r.filter(e=>e.id!==t.id))}function O(){return Object(f["a"])({method:"POST",path:"/api/v1/users/self/content_shares",body:{...t,receiver_ids:r.map(t=>t.id)}})}function C(){y("info")
O().then(S).catch(t=>{console.error(t)
t.response&&console.error(t.response)
y("error")})}function S(){Object(d["d"])(p.t("Content share started successfully"))()
n.onDismiss()}function j(){return o.a.createElement(o.a.Fragment,null,Object(i["a"])(l["a"],{onClick:n.onDismiss},void 0,p.t("Cancel")),Object(i["a"])(l["a"],{disabled:0===r.length||"info"===g,color:"primary",margin:"0 0 0 x-small",onClick:C},void 0,p.t("Send")))}const $=Object(i["a"])(c["a"],{as:"div",textAlign:"center"},void 0,Object(i["a"])(u["a"],{renderTitle:p.t("Loading")}))
if(n.open!==v.current){v.current=n.open
_()}let k=""
"info"===g?k=p.t("Starting content share"):"error"===g&&(k=p.t("Error starting content share"))
...
return o.a.createElement(h["a"],Object.assign({label:p.t("Send To..."),size:"medium"},n,{footer:Object(i["a"])(j,{})}),Object(i["a"])(s["Suspense"],{fallback:$},void 0,T,Object(i["a"])(b,{courseId:e,selectedUsers:r,onUserSelected:w,onUserRemoved:x})))}},TOwV:function(t,e,n){"use strict"
...
var i="function"===typeof Symbol&&Symbol.for,r=i?Symbol.for("react.element"):60103,s=i?Symbol.for("react.portal"):60106,o=i?Symbol.for("react.fragment"):60107,a=i?Symbol.for("react.strict_mode"):60108,l=i?Symbol.for("react.profiler"):60114,u=i?Symbol.for("react.provider"):60109,c=i?Symbol.for("react.context"):60110,h=i?Symbol.for("react.async_mode"):60111,d=i?Symbol.for("react.concurrent_mode"):60111,f=i?Symbol.for("react.forward_ref"):60112,p=i?Symbol.for("react.suspense"):60113,b=i?Symbol.for("react.suspense_list"):60120,m=i?Symbol.for("react.memo"):60115,g=i?Symbol.for("react.lazy"):60116,y=i?Symbol.for("react.block"):60121,v=i?Symbol.for("react.fundamental"):60117,_=i?Symbol.for("react.responder"):60118,w=i?Symbol.for("react.scope"):60119
function x(t){if("object"===typeof t&&null!==t){var e=t.$$typeof
switch(e){case r:switch(t=t.type,t){case h:case d:case o:case l:case a:case p:return t
default:switch(t=t&&t.$$typeof,t){case c:case f:case g:case m:case u:return t
default:return e}}case s:return e}}}function O(t){return x(t)===d}e.AsyncMode=h
e.ConcurrentMode=d
e.ContextConsumer=c
e.ContextProvider=u
e.Element=r
...
e.StrictMode=a
e.Suspense=p
e.isAsyncMode=function(t){return O(t)||x(t)===h}
e.isConcurrentMode=O
e.isContextConsumer=function(t){return x(t)===c}
e.isContextProvider=function(t){return x(t)===u}
e.isElement=function(t){return"object"===typeof t&&null!==t&&t.$$typeof===r}
e.isForwardRef=function(t){return x(t)===f}
e.isFragment=function(t){return x(t)===o}
e.isLazy=function(t){return x(t)===g}
e.isMemo=function(t){return x(t)===m}
e.isPortal=function(t){return x(t)===s}
e.isProfiler=function(t){return x(t)===l}
e.isStrictMode=function(t){return x(t)===a}
e.isSuspense=function(t){return x(t)===p}
e.isValidElementType=function(t){return"string"===typeof t||"function"===typeof t||t===o||t===d||t===l||t===a||t===p||t===b||"object"===typeof t&&null!==t&&(t.$$typeof===g||t.$$typeof===m||t.$$typeof===u||t.$$typeof===c||t.$$typeof===f||t.$$typeof===v||t.$$typeof===_||t.$$typeof===w||t.$$typeof===y)}
e.typeOf=x}}])

//# sourceMappingURL=57-c-816c6c0c7a.js.map