(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[75],{"+w22":function(e,t,n){"use strict"
n.r(t)
n.d(t,"enhanceUserContent",(function(){return O}))
n.d(t,"formatTimeAgoTitle",(function(){return N}))
n.d(t,"formatTimeAgoDate",(function(){return S}))
...
return(n>1?[t[n-2],t[n-1]]:t).join("")}const v=b(window.location.hostname)
s.a.expr[":"].external=function(e){const t=s()(e).attr("href")
return!!(t&&t.length&&!t.match(/^(mailto\:|javascript\:)/)&&e.hostname&&b(e.hostname)!=v)}
...
n("bgJ8")
n("UEsX")
const y=Object(o["useScope"])("instructure_js")
let x=0
function k(){return"preview_"+ ++x}function E(){const e=s()(this)
const t=e.attr("href")
...
i.click(Object(u["a"])((function(){const e=s()(`\n        <span class='youtube_holder' style='display: block;'>\n          <iframe\n            src='//www.youtube.com/embed/${Object(d["a"])(n)}?autoplay=1&rel=0&hl=en_US&fs=1'\n            frameborder='0'\n            width='425'\n            height='344'\n            allowfullscreen\n          ></iframe>\n          <br/>\n          <a\n            href='#'\n            style='font-size: 0.8em;'\n            class='hide_youtube_embed_link'\n          >\n            ${Object(d["a"])(y.t("links.minimize_youtube_video","Minimize Video"))}\n          </a>\n        </span>\n      `)
e.find(".hide_youtube_embed_link").click(Object(u["a"])(()=>{e.remove()
i.show()
Object(w["a"])("hide_embedded_content","hide_you_tube")}))
s()(this).after(e).hide()})))
Object(w["a"])("show_embedded_content","show_you_tube")
e.addClass("youtubed").after(i)}}function C(){Object(w["a"])("Route",window.location.pathname.replace(/\/$/,"").replace(/\d+/g,"--")||"/")}function T(e){try{return new URL(e)}catch(e){}}function I(){const e=document.createElement("div")
const t=p.a.createElement(_["a"],{elementRef:e=>{s()(".user_content a:has(img)").each((function(){s()(this).addClass(e.className)}))}},p.a.createElement("img"))
f.a.render(t,e)}function O(e){if(ENV.SKIP_ENHANCING_USER_CONTENT)return
const t=".dialog, .draggable, .resizable, .sortable, .tabs"
s()("#content")
const n=e===O.ANY_VISIBILITY?"":":visible"
s()(".user_content:not(.enhanced)"+n).addClass("unenhanced")
s()(".user_content.unenhanced"+n).each((function(){const e=s()(this)
e.find("img").each((e,t)=>{/hidden=1$/.test(t.getAttribute("src"))&&t.setAttribute("alt",y.t("This image is currently unavailable"))})
...
e.dialog()})})).end().filter(".draggable").draggable().end().filter(".resizable").resizable().end().filter(".sortable").sortable().end().filter(".tabs").each((function(){s()(this).tabs()})).end().end().find("a:not(.not_external, .external):external").each((function(){const e=Object(d["a"])(y.t("titles.external_link","Links to an external site."))
...
if(!n)return
let i,a
if(s.a.trim(e.text())){const n=this.textContent
const o=s()("<span class='instructure_file_holder link_holder instructure_file_link_holder'/>")
const r=t.searchParams
r.delete("wrap")
r.append("download_frd","1")
const l=`${t.origin}${t.pathname.replace(/(?:\/(download|preview))?$/,"/download")}?${r}`
i=s()(`<a class="file_download_btn" role="button" download style="margin-inline-start: 5px; text-decoration: none;" href="${Object(d["a"])(l)}">\n            <img style="width:16px; height:16px" src="/images/svg-icons/svg_icon_download.svg" alt="" role="presentation"/>\n            <span class="screenreader-only">\n              ${Object(d["a"])(y.t("Download %{filename}",{filename:n}))}\n            </span>\n          </a>`)
...
const t=e.src
e.src=t})}O.ANY_VISIBILITY={}
function N(e){const t=s.a.fudgeDateForProfileTimezone(e)
return t.toString("MMM d, yyyy h:mmtt")}function S(e){"string"===typeof e&&(e=Date.parse(e))
const t=new Date-e
if(t<864e5){if(t<36e5){if(t<6e4)return y.t("#time.less_than_a_minute_ago","less than a minute ago")
{const e=parseInt(t/6e4,10)
return y.t("#time.count_minutes_ago",{one:"1 minute ago",other:"%{count} minutes ago"},{count:e})}}{const e=parseInt(t/36e5,10)
return y.t("#time.count_hours_ago",{one:"1 hour ago",other:"%{count} hours ago"},{count:e})}}return N(e)}function A(){if(window._earlyClick){document.removeEventListener("click",window._earlyClick)
window._earlyClick.clicks&&setTimeout((function(){s.a.each(c.a.uniq(window._earlyClick.clicks),(function(){const e=s.a.Event("click")
e.preventDefault()
s()(this).trigger(e)}))}),1)}}function j(){const e=s()("#breadcrumbs")
if(e.length){let t
let n=false
const i=40.5
let a
...
o()
s()(window).resize(o)}}function R(){a["a"].prototype.bindOpenKeys.call({$el:s()("#keyboard_navigation")})}function q(){s()("#switched_role_type").ifExists((function(){const e=s()(this).attr("class")
const t=s()("<img/>")
let n=null
switch(s()(this).data("role")){case"TeacherEnrollment":n=y.t("switched_roles_message.teacher","You have switched roles temporarily for this course, and are now viewing the course as a teacher.  You can restore your role and permissions from the course home page.")
break
case"StudentEnrollment":n=y.t("switched_roles_message.student","You have switched roles temporarily for this course, and are now viewing the course as a student.  You can restore your role and permissions from the course home page.")
break
case"TaEnrollment":n=y.t("switched_roles_message.ta","You have switched roles temporarily for this course, and are now viewing the course as a TA.  You can restore your role and permissions from the course home page.")
break
case"ObserverEnrollment":n=y.t("switched_roles_message.observer","You have switched roles temporarily for this course, and are now viewing the course as an observer.  You can restore your role and permissions from the course home page.")
break
case"DesignerEnrollment":n=y.t("switched_roles_message.designer","You have switched roles temporarily for this course, and are now viewing the course as a designer.  You can restore your role and permissions from the course home page.")
break
default:n=y.t("switched_roles_message.student","You have switched roles temporarily for this course, and are now viewing the course as a student.  You can restore your role and permissions from the course home page.")}t.attr("src","/images/warning.png").attr("title",n).css({paddingRight:2,width:12,height:12})
s()("#crumb_"+e).find("a").prepend(t)}))}function z(){s()("a.show_quoted_text_link").live("click",(function(e){const t=s()(this).parents(".quoted_text_holder").children(".quoted_text")
if(t.length>0){e.preventDefault()
t.show()
s()(this).hide()}}))}function L(){s()("a.equella_content_link").live("click",(function(e){e.preventDefault()
let t=s()("#equella_preview_dialog")
if(!t.length){t=s()("<div/>")
t.attr("id","equella_preview_dialog").hide()
t.html("<h2/><iframe style='background: url(/images/ajax-loader-medium-444.gif) no-repeat left top; width: 800px; height: 350px; border: 0;' src='about:blank' borderstyle='0'/><div style='text-align: right;'><a href='#' class='original_link external external_link' target='_blank'>"+Object(d["a"])(y.t("links.view_equella_content_in_new_window","view the content in a new window"))+"</a>")
t.find("h2").text(s()(this).attr("title")||s()(this).text()||y.t("titles.equella_content_preview","Equella Content Preview"))
const e=t.find("iframe")
setTimeout(()=>{e.css("background","#fff")},2500)
s()("body").append(t)
t.dialog({autoOpen:false,width:"auto",resizable:false,title:y.t("titles.equella_content_preview","Equella Content Preview"),close(){t.find("iframe").attr("src","about:blank")}})}t.find(".original_link").attr("href",s()(this).attr("href"))
t.dialog("close").dialog("open")
t.find("iframe").attr("src",s()(this).attr("href"))}))}function D(){s()(".dialog_opener[aria-controls]:not(.user_content *)").live("click",(function(e){const t=this
...
n.fixDialogButtons()}n.dialog("open")})}))}function H(){s()("a.file_preview_link, a.scribd_file_preview_link").live("click",(function(e){if(e.ctrlKey||e.altKey||e.metaKey||e.shiftKey)return
e.preventDefault()
const t=s()(this)
...
s.a.ajaxJSON(t.attr("href").replace(/\/(download|preview)/,"").replace(/wrap=1&?/,"").replace(/[?&]$/,""),"GET",{},n=>{const i=n&&n.attachment
t.loadingImage("remove")
if(i&&(s.a.isPreviewable(i.content_type,"google")||i.canvadoc_session_url)){const n=s()(`[id="${t.attr("aria-controls")}"]`)
...
const a=s()('<a href="#" style="font-size: 0.8em;" class="hide_file_preview_link">'+Object(d["a"])(y.t("links.minimize_file_preview","Minimize File Preview"))+"</a>").click(e=>{e.preventDefault()
t.attr("aria-expanded","false")
t.show()
t.focus()
n.html("").css("display","none")
Object(w["a"])("hide_embedded_content","hide_file_preview")})
n.prepend(a)
Object.prototype.hasOwnProperty.call(e,"originalEvent")&&a.focus()
Object(w["a"])("show_embedded_content","show_file_preview")}},()=>{t.loadingImage("remove").hide()})}))
...
const r=o[1]
Promise.all([n.e(6),n.e(25),n.e(47),n.e(126),n.e(4135)]).then(n.bind(null,"xTOM")).then(e=>{e.showFilePreview(r,i)}).catch(e=>{s.a.flashError(y.t("Something went wrong loading the file previewer."))})}})}function F(){let e
s.a.subscribe("userContent/change",()=>{clearTimeout(e)
e=setTimeout(O,50)})
s()(document).bind("user_content_change",O)}function B(){s()(()=>{setInterval(O,15e3)
setTimeout(O,15)})}function M(){s()(".show_sub_messages_link").click((function(e){e.preventDefault()
...
s()(this).parents(".communication_sub_message").remove()}))}function P(){s()(".communication_message .add_entry_link").click((function(e){e.preventDefault()
...
n.before(i.show())
const a=c.a.uniqueId("textarea_")
i.find("textarea.rich_text").attr("id",a)
s()(document).triggerHandler("richTextStart",s()("#"+a))
i.find("textarea:first").focus().select()}))}function V(){s()(document).bind("richTextStart",(e,t)=>{if(!t||0===t.length)return
t=s()(t)
if(!t||0===t.length)return
h["a"].loadNewEditor(t,{focus:true})}).bind("richTextEnd",(e,t)=>{if(!t||0===t.length)return
t=s()(t)
if(!t||0===t.length)return
h["a"].destroyRCE(t)})}function W(){s()(".communication_sub_message .add_sub_message_form").formSubmit({beforeSubmit(e){s()(this).find("button").attr("disabled",true)
s()(this).find(".submit_button").text(y.t("status.posting_message","Posting Message..."))
...
s()(this).remove()
window.location.href.match(/dashboard/)&&Object(w["a"])("dashboard_comment","create")},error(e){s()(this).loadingImage("remove")
s()(this).find("button").attr("disabled",false)
s()(this).find(".submit_button").text(y.t("errors.posting_message_failed","Post Failed, Try Again"))
s()(this).formErrors(e)}})}function U(){s()(".communication_sub_message form .cancel_button").click((function(){const e=s()(this).parents(".communication_sub_message")
const t=s()(this).parents(".communication_message")
s()(document).triggerHandler("richTextEnd",e.find("textarea.rich_text"))
e.remove()
t.find(".reply_message").show()}))}function $(){s()(".communication_message,.communication_sub_message").bind("focusin mouseenter",(function(){s()(this).addClass("communication_message_hover")})).bind("focusout mouseleave",(function(){s()(this).removeClass("communication_message_hover")}))}function J(){let e=[]
function t(){e=[...document.querySelectorAll(".time_ago_date")].filter(s.a.expr.filters.visible)
...
e.text(S(t))
e.attr("title",N(t))}setTimeout(n,1)}else setTimeout(t,6e4)}setTimeout(t,100)}function K(){const e=s()("#sequence_footer")
if(e.length){const t=s()(e[0])
Promise.all([n.e(14),n.e(191)]).then(n.bind(null,"fY8A")).then(()=>{t.moduleSequenceFooter({courseID:t.attr("data-course-id"),assetType:t.attr("data-asset-type"),assetID:t.attr("data-asset-id")})})}}function G(){s()("#right-side").delegate(".more_link","click",(function(e){const t=s()(this)
const n=t.parents("ul").children(":hidden").show()
t.closest("li").remove()
0===e.screenX&&n.first().find(":tabbable:first").focus()
return false}))}function Y(){s()("#right-side").on("click",".disable-todo-item-link",(function(e){e.preventDefault()
...
i.focus()}))}})}r(a)}))}function Q(){setTimeout((function(){const e=document.getElementById("content")
if(!e)return
...
if(i.length){const e=y.t("titles.external_link","Links to an external site.")
const t=s()('<span class="ui-icon ui-icon-extlink ui-icon-inline"/>').attr("title",e)
t.append(s()('<span class="screenreader-only"/>').text(e))
i.addClass("external").children("span.ui-icon-extlink").remove().end().html("<span>"+n.html()+"</span>").attr("target","_blank").attr("rel","noreferrer noopener").append(t)}}}),100)}function X(){[C,A,j,R,q,z,L,D,H,F,B,M,P,V,W,U,$,J,K,G,Y,Q].map(i["a"]).map(e=>e())}},"/oRJ":function(e,t,n){"use strict"
...
this.loadRCE(e=>{e.renderIntoDiv(a,o,e=>{e.tinymceOn("init",()=>n(i,p.wrapEditor(e)))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){return Promise.all([n.e(6),n.e(7),n.e(8),n.e(10),n.e(11),n.e(13),n.e(15),n.e(17),n.e(19),n.e(20),n.e(23),n.e(28),n.e(41),n.e(3746)]).then(n.bind(null,"j/Fk")).then(e=>{this.RCE=e
Object(h["a"])()
...
let i;(function(e){e[e["IconMaker"]=0]="IconMaker"})(i||(i={}))
function a(e,t){switch(e){case i.IconMaker:return o(t)
...
//# sourceMappingURL=75-c-aca591a9bd.js.map